...
class MockPostsRepository implements PostsRepository {
  ...
  final List<Post> _posts = [
    Post(
      ...
      role: 'Owner',
      avatarUrl:
          'https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?q=80&w=200&auto=format&fit=crop',
      timeAgo: '2h ago',
      statusText:
    ...
    Post(
      ...
      role: 'Mechanic',
      avatarUrl:
          'https://images.unsplash.com/photo-1580674684081-7617fbf3d745?q=80&w=200&auto=format&fit=crop',
      timeAgo: '4h ago',
      statusText:
          'Engine repair, clutch replacement, general service.\nAll types of trucks & trailers.',
      imageUrl:
    ...
    Post(
      ...
      timeAgo: '6h ago',
      statusText:
          'Urgent Load Available: 18-ton capacity cargo for immediate shipment from Chennai to Bangalore.\nBest freight rates guaranteed.',
      imageUrl:
          'https://images.unsplash.com/photo-1591768793355-74d75b50f58f?q=80&w=600&auto=format&fit=crop',
      likeCount: 42,
      commentCount: 4,
      isLiked: false,
      isBookmarked: false,
