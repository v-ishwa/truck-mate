...
/// Screen that lists all users that a given user follows.
...
class _FollowingListScreenState extends State<FollowingListScreen> {
  ...
  Future<void> _loadFollowing() async {
    ...
    final users = await _followRepo.getFollowing(widget.userId);
    if (mounted) {
      setState(() {
        _users = users;
        _isLoading = false;
...
/// Row card for a single user in the following list.
